// src/main/java/com/VolunTrack/demo/IAM/Infrastructure/Authorization/Sagas/Security/UserDetailsServiceImpl.java
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        User user = userRepository.findByUsername(username) // Usamos findByUsername de UserRepository
